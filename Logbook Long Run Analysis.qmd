...
![Logbook Long Run Days (Original XLSX) Format](Logbook%20Raw%20Example.png)
...
![Original Critical Process Parameters (CPP) Events Sheet](Logbook%20Long%20Run%20Overview%201.png){fig-align="left"}

![Updated Critical Process Parameters (CPP) Events Sheet](Updated%20logbook%20CPP%20Example.png)

![Original Critical Quality Attributes (CQA) Events Sheet](Logbook%20Long%20Run%20Overview%202.png){fig-align="right"}

![Updated Critical Quality Attributes (CQA) Events Sheet](Updated%20logbook%20CQA%20Example.png)
...
![LogBook Incident Frequncy Chart](LogBook Incident Frequency Chart.png){fig-alt="by Group"}
...
![LiW Feeder 1 Totalizer Over Time](Loss-In-Weight-Feeders_files/figure-html5/PD1-1.png)
...
![LiW Feeder 5 Totalizer Over Time](Loss-In-Weight-Feeders_files/figure-html5/PD5-1.png)
...
Moving forward I will continue to work and read the following:

-   *The Effect of Processing Parameters on Pharmaceutical Tablet Poperties* (Sinka et al 2009)

-   *Intelligent Extraction of Manufacturing System Components From Natural Language Using Transformer Models* (Boudribila et al. 2025)

-   *Enhancing Maintenance Data Analytics: A Novel Failure Mode and Effect Analysis-Natural Language Processing Integration* (Payette et al 2025)
